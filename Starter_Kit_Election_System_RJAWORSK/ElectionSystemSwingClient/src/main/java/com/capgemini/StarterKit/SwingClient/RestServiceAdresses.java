...
public final class RestServiceAdresses {
	...
	public static final String SAVE_RESULTS_TO_DATABASE_GET = "http://localhost:8080/ElectionRestServiceDAO/ElectionRest/result/createStr/";
	public static final String SAVE_RESULTS_TO_DATABASE_POST = "http://localhost:8080/ElectionRestServiceDAO/ElectionRest/result/create";
}
